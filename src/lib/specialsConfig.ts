...
export const DISPLAY_NAMES: Record<string, string> = {
  ...
  "Endgame Gear OP1 8k v2 Config Tool v1.07.zip": "OP1 8k v2 Config Tool (v1.07)",
  "Endgame Gear OP1 8k v2 Firmware Updater 1.10.zip": "OP1 8k v2 Firmware Updater (1.10)",
