import { ALL_CATEGORY_ID, FAVORITES_CATEGORY_ID, HOME_CATEGORY_ID } from "./constants";
...
const PATHS: Record<string, string[]> = {
  ...
  [HOME_CATEGORY_ID]: ["M3.5 10.5 12 3.5l8.5 7", "M5.5 9v10.5h4.5v-5.5h4v5.5h4.5V9"],
