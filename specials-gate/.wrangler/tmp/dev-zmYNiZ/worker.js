...
var worker_default = {
  async fetch(request, env) {
    ...
    if (url.pathname === "/list") {
      ...
      const listing = await env.SPECIALS_BUCKET.list({ prefix, limit: 1e3 });
      return cors(
        json({
          ok: true,
...
// .wrangler/tmp/bundle-7tZ5KJ/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-7tZ5KJ/middleware-loader.entry.ts
